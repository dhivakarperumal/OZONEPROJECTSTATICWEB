    ...
    return (
        <>
            <div className="text-center mb-12">
                <span className="inline-flex items-center px-4 py-2 rounded-full bg-[#0c5940]/10 text-[#0c5940] font-semibold text-sm mb-4">
                    📍 Our Coverage
                </span>
                ...
                <p className="max-w-3xl mx-auto text-gray-600 text-lg leading-relaxed">
                    We proudly provide premium mosquito net solutions, UPVC windows & doors,
                    window blinds, sales, installation, and after-sales service across our
                    major service locations in Tamil Nadu.
                </p>
            </div>
